	...
	$('input:radio').click(function (){ 
		if($('input[name="Radio1"]:checked').val()!="custom"){
			...
			if(selectType=="" || selectType==null){
				...
				selUrl="/stock/"+_accountId+"/getBusinessPage.jspa";
			}else{
				selUrl="/stock/"+_accountId+"/getHistoryBusinessPage.jspa";
			}
	        ...
	        var startdate=$("#cal-1").val().replace(/-/g,"");
			var enddate =$("#cal-2").val().replace(/-/g,"");
			var selUrl="/stock/"+_accountId+"/getHistoryBusinessPage.jspa";
			var selectType =$('input[name="Radio1"]:checked').val();
			getContent(selUrl,1,selectType,startdate,enddate);
		}
	}); 
...
//				var dateCount = (_end - _begin)/86400000;
				...
				nextUrl="/stock/"+_accountId+"/getHistoryBusinessPage.jspa";
			}else if(selectType=="today"){//当日
				nextUrl="/stock/"+_accountId+"/getBusinessPage.jspa";
			}else{
				nextUrl="/stock/"+_accountId+"/getHistoryBusinessPage.jspa";
			}
