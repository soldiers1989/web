...
$(document).ready(function(){
	...
	$('input:radio').click(function (){ 
		if($('input[name="Radio1"]:checked').val()!="custom"){
			...
			selUrl="/stock/hk/"+_accountId+"/searchBankFund.jspa";
	        ...
	        var startdate=$("#cal-1").val().replace(/-/g,"");
			var enddate =$("#cal-2").val().replace(/-/g,"");
	        var selUrl="/stock/hk/"+_accountId+"/searchBankFund.jspa";
	        var selectType =$('input[name="Radio1"]:checked').val();
	        getContent(selUrl,1,selectType,startdate,enddate);
		}
	}); 
...
//			var dateCount = (_end - _begin)/86400000;
			...
			if(JRJ.date.getDateDiff($("#cal-1").val(),$("#cal-2").val())>90 || JRJ.date.getDateDiff($("#cal-1").val(),$("#cal-2").val())<0){
...
//				var dateCount = (_end - _begin)/86400000;
				...
				nextUrl="/stock/hk/"+_accountId+"/searchBankFund.jspa";
			}else{
				nextUrl="/stock/hk/"+_accountId+"/searchBankFund.jspa";
			}
