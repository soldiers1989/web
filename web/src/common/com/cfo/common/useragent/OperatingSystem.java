...
public enum OperatingSystem {
	...
	WINDOWS_10(	Manufacturer.MICROSOFT,OperatingSystem.WINDOWS,23, "Windows 10", new String[] { "Windows NT 10" }, null, DeviceType.COMPUTER, null ), // before Win, yes, Windows 7 is called 6.1 LOL
	WINDOWS_10_tp(	Manufacturer.MICROSOFT,OperatingSystem.WINDOWS,23, "Windows 10", new String[] { "Windows NT 6.4" }, null, DeviceType.COMPUTER, null ), // before Win, yes, Windows 7 is called 6.1 LOL
	WINDOWS_8_1(	Manufacturer.MICROSOFT,OperatingSystem.WINDOWS,23, "Windows 8.1", new String[] { "Windows NT 6.3" }, null, DeviceType.COMPUTER, null ), // before Win, yes, Windows 7 is called 6.1 LOL
